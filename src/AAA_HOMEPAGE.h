...
<meta http-equiv="refresh" content="112"> <!-- Refresh the page every 112 seconds -->
...
<div id='msect'>
    <div class='divstijl' id='maindiv'>
        ...
        <div id="busy">
            <span style="color:red;"><h3>checking / initializing zigbee network...</h3></span><br>
        </div>
...
// JavaScript functions stored in PROGMEM
...
function celbgc(cel) {
  // Change background color based on cell type
  if(cel.startsWith("e")) {
    ...
    document.getElementById(cel).style = "background-color:#a6a6a6";
  }
}
